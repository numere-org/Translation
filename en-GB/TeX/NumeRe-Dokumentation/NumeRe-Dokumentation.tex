...
endprocedure                                 ## Procedure tail
				...
				The mentioned >>flags<< influence the processing of a \NR\ procedure as a whole and suppress or allow a distinct behaviour of \NR\ in this procedure. However, a correct usage of flags requires the knowledge of the following sections and chapters:\cmd{explicit\\private\\inline}
				\begin{lstlisting}
explicit
private
inline
